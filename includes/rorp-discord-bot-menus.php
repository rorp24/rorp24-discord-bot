...
function page_gestion_rorp_discord_bot() {
  add_menu_page('rorp discord-bot','rorp discord-bot','manage_options','rorp-discord-bot-accueil','montrer_rorp_discord_bot_accueil_page',''/*une image*/,24);
  add_submenu_page("rorp-discord-bot-accueil", "Accueil", "Accueil", "manage_options", "rorp-discord-bot-accueil", "montrer_rorp_discord_bot_accueil_page");
...
function montrer_rorp_discord_bot_accueil_page(){
